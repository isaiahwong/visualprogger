...
/***/ function(module, exports, __webpack_require__) {
	...
	var GUI = function GUI(pars) {
	  ...
	  /**
	   * List of raycasterObjects I'm remembering for save, only used in top level GUI
	   * @ignore
	   */
	  this.__rememberedObjects = [];
	
	  /**
	   * Maps the index of remembered raycasterObjects to a map of controllers, only used
	   * in top level GUI.
	   *
	   * @private
	   * @ignore
	...
	/** @lends dat.gui.GUI */
	{
	  ...
	  /**
	   * Mark raycasterObjects for saving. The order of these raycasterObjects cannot change as
	   * the GUI grows. When remembering new raycasterObjects, append them to the end
	   * of the list.
	   *
	   * @param {Object...} raycasterObjects
	...
	function recallSavedValue(gui, controller) {
	  // Find the topmost GUI, that's where remembered raycasterObjects live.
